...
def crear_flotaj1():
    ...
    eslora=[2,2,2,3,3,4]
    for n in eslora:
       flota1.append(crear_barco_aleatorioj1(n))
    return flota1 
...
def crear_flotaj2():
    ...
    eslora=[2,2,2,3,3,4]
    for n in eslora:
       flota2.append(crear_barco_aleatorioj2(n))
    return flota2 
...
def colocar_barcosj1(flota1,tab_jug1): 
    for barco in flota1:
        colocar_barcoj1(barco, tab_jug1)
    return tab_jug1

def colocar_barcosj2(flota2, tab_jug2): 
    for i in flota2:
        colocar_barcoj2(i, tab_jug2)
    return tab_jug2
